					...
					<figure>
						<div class="snipcart-item block">
							<div class="snipcart-thumb">
								<a href="{{route('products.show', $product->id)}}"><img style="width: 100%; height:200px;" src="{{asset($product->images->first()? $product->images->first()->path:'http://via.placeholder.com/300')}}" alt=" " class="img-responsive" /></a>
								<p>{{ $product->name }}</p>
